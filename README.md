...
### เหตุผลที่เลือก Node.js กับ Express.js
เนื่องจากผมลองใช้ Spring Boot แล้วมีความซับซ้อนพอสมควร ประกอบกับเคยใช้ Node.js ทำงานในรายวิชา 02739241 ที่มีโครงสร้างง่ายกว่า จึงเลือกใช้ Node.js ทำงานนี้ (จริง ๆ แล้วผมแค่ไม่ชอบ Java)
...
git clone https://github.com/TitaniumSalmon/cooptest2569
cd cooptest2569
...
node seeders/seed.js        # สร้าง Seed data
